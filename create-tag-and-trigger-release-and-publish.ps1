...
[string]$githubProjectUrl = 'https://github.com/CompuMasterGmbH/CompuMaster.Data.XlsEpplus/' #must contain trailing slash!
[string]$masterBranchName = "master" #ususally 'master' or 'main'
[string]$assemblyVersionSourceFilePath = ".\XlsEpplus\XlsEpplus.vbproj"
